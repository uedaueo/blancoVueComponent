...
public class BlancoValueObjectMessage {
    ...
    /**
     * メッセージ定義ID[BlancoValueObject]、キー[MBVOJI01]の文字列を取得します。
     *
     * No.2:
    ...
    /**
     * メッセージ定義ID[BlancoValueObject]、キー[MBVOJI02]の文字列を取得します。
     *
     * No.3:
    ...
    /**
     * メッセージ定義ID[BlancoValueObject]、キー[MBVOJI03]の文字列を取得します。
     *
     * No.4:
    ...
    /**
     * メッセージ定義ID[BlancoValueObject]、キー[MBVOJI04]の文字列を取得します。
     *
     * No.5:
    ...
    /**
     * メッセージ定義ID[BlancoValueObject]、キー[MBVOJI05]の文字列を取得します。
     *
     * No.6:
